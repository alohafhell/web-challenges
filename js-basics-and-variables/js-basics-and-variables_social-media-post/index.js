...
*/
let postTitle = "Taylor Swift's new album!";
let postContent =
  "Taylor Swift just released her highly anticipated album, and fans are loving it! The tracks are filled with emotion and catchy melodies. Have you listened yet?";
let postLikes = "13000";
let postUser = "alohafhelll";
...
*/
console.log(postTitle, postContent, postLikes, postUser, isReported);
